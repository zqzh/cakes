 ...
 * @author haoc
 */
public final class XmenPair<K, V> implements Serializable {
   ...
   */
  private XmenPair(@NamedArg("key") K key, @NamedArg("value") V value) {
    this.key = key;
    this.value = value;
  }

  public static <K, V> XmenPair<K, V> of(K key, V value) {
    return new XmenPair<>(key, value);
  }
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof XmenPair) {
      XmenPair pair = (XmenPair) o;
